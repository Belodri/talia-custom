...
const JOKES = [
    ...
    "You're so dense, the barbarian can use you for weight training.",
    "Your head is so empty,  I could blow into your ear and you would thank me for the refill.",
    "You're like a cloud. It's a beautiful day when you disappear.",
    "You have two braincells and they're fighting for third place.",
    "You may not be the king of fools, but you do have the keys to his castle.",
    "You may not be the village idiot, but you really don't want him to die.",
    "You always manage to snatch defeat from the jaws of victory.",
    "Wisdom has been chasing you all your life. You've just been faster.",
    "Light travels faster than sound, which is why you seemed bright until you spoke.",
    "When I look at you I think, 'Where have you been all my life?' and 'Can you go back there?'",
    "If you ever had a clever thought, it died alone and afraid.",
    "Your mind is as sharp as a butter knife."
];
